...
try {
    ...
    echo "<h1>Cliente SOAP con WSDL y Clases</h1>";

    $idProducto = '2';
    $pvp = $client->getPVP($idProducto);
    echo "<h2>PVP del producto</h2>";
    echo "<table>";
    echo "<tr><th>ID Producto</th><th>PVP (€)</th></tr>";
    echo "<tr><td>$idProducto</td><td>$pvp</td></tr>";
    echo "</table>";

    $stock = $client->getStock($idProducto, 1);
    echo "<h2>Stock del producto</h2>";
    echo "<table>";
    echo "<tr><th>ID Producto</th><th>ID Tienda</th><th>Unidades</th></tr>";
    echo "<tr><td>$idProducto</td><td>1</td><td>$stock</td></tr>";
    echo "</table>";
